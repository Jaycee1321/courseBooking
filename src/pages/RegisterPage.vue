...
<script setup>
    ...
    import api from '../api.js'; // import our axios instance called "api"
    ...
    //Add the additional input states to be watched.
    ...
    async function handleSubmit(){
        ...
        try {
            ...
            //     email: email.value
            // })
            // use the api instance and remove the base url
    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-5 border border rounded-3 mx-auto p-5">
                <!-- submit.prevent will prevent the default behavior of the submit event such as refreshing the page -->
                <!-- so there is no need to pass the event (e) object in the handleSubmit function -->
